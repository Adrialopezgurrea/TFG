...
def calculate_average_ctdi_vol(directory_path):
            ...
            for series_dir in os.listdir(patient_dir_path):
                ...
                if os.path.isdir(series_dir_path):
                    ...
                    for file in os.listdir(series_dir_path):
                            ...
                            if file.lower().endswith(".dcm"): #Comprueba que ele archivo tenga formato DICOM
                                dicom_file_path = os.path.join(series_dir_path, file)
                    ...
                    if ctdi_values:
                        ...
                        print(f"Media de CTDIvol para paciente {patient_dir}, serie {series_dir} del equipo "Nombre_Equipo": {series_average}")
    ...
    for patient_id, patient_values in patient_ctdi.items():
        ...
        print(f"Media de CTDIvol para paciente {patient_id} del equipo "Nombre_Equipo": {patient_average}")

if __name__ == "__main__":
    directory_path = "Ruta/Carpeta/Imagenes/DICOM"
